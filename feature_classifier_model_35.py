...
data_train_set_path = r'G:\Meine Ablage\EdgeAI\Data\TrainSet'
data_test_set_path = r'G:\Meine Ablage\EdgeAI\Data\TestSet'
...
def parse_dir(path, df, train_set_type):
    ...
    return df # gibt das DF zurück(nicht mehr df_small_test)


# Checkpoint Speichern - am Ende jeder Epoch --->ColabMESS
...
def train_loop(clf, df, resume_from=None):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('training_curves_35.png', dpi=300, bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    # print(f'Anzahl der Label = {num_classes}')
    ...
    label_encoder = train_loop(classifier, df, resume_from='checkpoint_35.pt')
